...
@Client.on_callback_query(filters.regex("الاوامر"))
...
**[{BOT_NAME}](https://t.me/{BOT_USERNAME})** برنامج Music Bot هو الروبوت المصمم بواسطة @UU_222 لتشغيل موسيقى عالية الجودة وغير قابلة للكسر في الدردشة الصوتية الجماعية.
        ...
        reply_markup=InlineKeyboardMarkup(
            [
              [
                    ...
                    InlineKeyboardButton("⚙️ ¦ الـسورس", url=f"https://t.me/Tom01255")
                ],
            [InlineKeyboardButton("💭 ¦ لـي تنـصيـب بـوتـك مجـاني", url=f"https://t.me/UU_222")],
            [InlineKeyboardButton("↩️ ¦ رجــوع", callback_data="cbhome")]]
        ),
    )
