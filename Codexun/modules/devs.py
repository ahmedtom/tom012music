...
@app.on_message(command(["اعادة تشغيل", "/restart"]) & filters.user(OWNER_ID))
@check_heroku
...
async def update(_, message: Message):
    ...
    if str(m[0]) != "A":
        ...
        await message.reply_text("Bot is already in the **up-to-date** mode with **[latest version](https://github.com/ahmedtom/tom012music)**", disable_web_page_preview=True)
