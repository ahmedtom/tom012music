...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ahmedtom/tom012music")
USERS = getenv("5283518897")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5283518897").split()))
